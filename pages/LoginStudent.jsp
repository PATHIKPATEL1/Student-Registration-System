...
<body>
        ...
        <div id="rcorners1" style="text-align:center">
            ...
            <div style="margin-top: 5px;margin-bottom: 0px;"><img src="../image/studentlogin.png" style="height: 120px;width: 130px;">
                <p style="text-align: center;margin-top: 0px;margin-bottom: 0px;"><b>Student</b></p>
            </div>
            <div><p id="warning" style="color:red;opacity: 0;">Invalid username or password.</p></div>
            <div id="log">
                <form action="ValidationStudent.jsp" method="post">
  ...
  <div class="container">
    ...
    <div class="container" style="margin-top:2px;">
        ...
        <a onclick="Navigate()"><img src="../image/admin.png" title="Admin" class="im" style="height: 55px;width: 55px;margin-left:254px;margin-top: 5px;"></a>
